 ...
 **/
/datum/proc/ui_interact_tgui(mob/user, ui_key = "main", datum/tgui/ui = null, force_open = FALSE, datum/tgui/master_ui = null, datum/ui_state/state = GLOB.default_state)
 ...
 **/
 //NANO REMOVAL MARKER
 //This one is already defined by nano so we're commenting this out here.
 //Hopefully one day nano can be removed and you'll need this again
 /*
 ...
 **/
 //NANO REMOVAL MARKER
 //Defined by nano already. Uncomment this if removing nano
